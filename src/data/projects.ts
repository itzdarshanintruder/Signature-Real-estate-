...
export const projects: Project[] = [
  ...
  // ─── Namakkal ──────────────────────────────────────────────────────────────
  {
    ...
    amenities: ['Gated Community', '24×7 Security', 'Parks', 'Avenue Trees', 'Solar Street Lights'],
    images: [{ alt: 'Hitech City layout, Namakkal', caption: 'Layout overview' }],
    gallery: [
      { alt: 'Hitech City avenue view', caption: 'Avenue view' },
      { alt: 'Hitech City grand entrance', caption: 'Grand entrance' },
      { alt: 'Landscaped park, Hitech City', caption: 'Central park' },
      { alt: 'Solar street lights, Hitech City', caption: 'Solar-lit streets' },
    ],
    masterPlan: { alt: 'Hitech City master plan, Namakkal', caption: 'Master plan' },
    availablePlots: [
  ...
  // ─── Madurai ───────────────────────────────────────────────────────────────
  {
    ...
    amenities: ['Gated Community', '24×7 Security', 'Parks', 'Avenue Trees', 'Solar Street Lights'],
    images: [{ alt: 'Emerald City layout, Madurai', caption: 'Layout overview' }],
    gallery: [
      { alt: 'Emerald City avenue view, Madurai', caption: 'Avenue view' },
      { alt: 'Emerald City grand entrance', caption: 'Grand entrance' },
      { alt: 'Emerald City central park', caption: 'Central park' },
      { alt: 'Solar street lights, Emerald City', caption: 'Solar-lit streets' },
    ],
    masterPlan: { alt: 'Emerald City master plan, Madurai', caption: 'Master plan' },
    availablePlots: [
  ...
  // ─── Trichy ────────────────────────────────────────────────────────────────
  {
    ...
    amenities: ['Gated Community', '24×7 Security', 'Parks', 'Avenue Trees', 'Solar Street Lights'],
    images: [{ alt: 'Up Town layout, Trichy', caption: 'Layout overview' }],
    gallery: [
      { alt: 'Up Town avenue view', caption: 'Avenue view' },
      { alt: 'Up Town grand entrance', caption: 'Grand entrance' },
      { alt: 'Up Town central park', caption: 'Central park' },
      { alt: 'Solar-lit streets, Up Town', caption: 'Solar-lit streets' },
    ],
    masterPlan: { alt: 'Up Town master plan, Trichy', caption: 'Master plan' },
    availablePlots: [
